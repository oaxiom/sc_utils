...
The C4 uses a double barcode system, I guess as it may help in barcode correction.

However, in practice barcode correction is around ~5% of total reads, and at best any
...
oh = open('c4_barcodes_doubles.txt', 'wt')
for b1 in barcodes:
    for b2 in barcodes:
        oh.write(f"{b1}{b2}\n")
        done += 1
